							...
							<?php } ?>
								...
								if ($jml_data > 0){
									...
									<?php } ?>
												...
												<td>
													<b>Created:</b> <?php echo dateIndo($row2->barang_created);?><br>
													<b>Last Updated:</b> <?php echo dateIndo($row2->barang_updated);?>
									</td>
                            <?php if ($admin->admin_level_kode == 1) { ?>
						...
						<div class="panel-body container-fluid">
							<form action="<?php echo site_url();?>website/masuk/tambah" method="post" id="exampleStandardForm" autocomplete="off">
								...
								<div class="form-group form-material">
									...
									<label class="control-label" for="inputText">Data</label>
